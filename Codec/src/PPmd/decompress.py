...
# 
# Usage: python decompress.py InputFile OutputFile
# This decompresses files generated by the compress.py application.
# 
...
# Must be at least -1 and match compress.py. Warning: Exponential memory usage at O(257^n).
MODEL_ORDER = 3
